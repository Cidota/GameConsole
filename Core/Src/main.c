...
static void MX_GPIO_Init(void) {
	...
	LL_GPIO_ResetOutputPin(GPIOA,
			LCD_RD_A0_Pin | LCD_WR_A1_Pin | LCD_RS_A2_Pin | LCD_D7_D7_Pin
					| LDC_D0_D8_Pin | LCD_D2_D2_Pin);

	/**/
	LL_GPIO_ResetOutputPin(GPIOB,
			LCD_CS_A3_Pin | LCD_D6_D6_Pin | LCD_D3_D3_Pin | LCD_D5_D5_Pin
					| LCD_D4_D4_Pin);
	...
	/**/
	GPIO_InitStruct.Pin = LCD_RD_A0_Pin | LCD_WR_A1_Pin | LCD_RS_A2_Pin
			| LCD_D7_D7_Pin | LDC_D0_D8_Pin | LCD_D2_D2_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
	GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
	GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	...
	/**/
	GPIO_InitStruct.Pin = LCD_CS_A3_Pin | LCD_D6_D6_Pin | LCD_D3_D3_Pin
			| LCD_D5_D5_Pin | LCD_D4_D4_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
	GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
	GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
